...
#revise this to your model path
cel = torch.load('/content/drive/MyDrive/Colab Notebooks/pi-GAN/CelebA/CelebA/generator.pth', map_location=torch.device(device))
generator = torch.load(opt.generator_path, map_location=torch.device(device))
cel.load_state_dict(generator)
generator = cel
